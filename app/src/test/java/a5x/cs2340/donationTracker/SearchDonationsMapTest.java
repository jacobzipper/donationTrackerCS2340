...
public class SearchDonationsMapTest {
    ...
    public void allNonNullTest() {
        ...
        assertEquals("Category was not expected value", "Category",
                searchDonationsMap.get("category"));
        assertEquals("Location was not expected value", "Location",
                searchDonationsMap.get("location"));
